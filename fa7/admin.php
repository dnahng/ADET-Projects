...
<html>
    ...
    <br><br>
        ...
        <li style='float:right; list-style-type:none;'><a href='viewusers.php' class='a1' style='color:dimgray; border-radius:10px;'><b><u>View Records</u></b></a></li><br><br>
        <li style='float:right; list-style-type:none;'><a href='admin_add.php' class='a1' style='color:dimgray; border-radius:10px;'><b><u>Add Records</u></b></a></li>
        <br>
        ...
        <br><br><input type="file" name="pic" id="pic" onchange="this.form.submit()" style="float:right; margin-right:-70px;">
        <?php
        if (isset($_POST['pic'])) {
